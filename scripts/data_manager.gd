...
@onready var general_data ={
	...
	"amount_per_click" : 1,
	"dino_souls" : 0,
	"dino_unlocked" : {"stego" : true, "ptero" : false},
...
@onready var base_dino_stats = {
	...
	"ptero" : {"base_price" : 1, "current_price" : 1, "number" : 0, "stomp_per_jump": 0},
...
func _on_game_over_stats_reset_data() -> void:
	...
	meteorite_data = {"pos_x": 20.0, "pos_y": 35.0, "scale" : 1.0,  "power_timer" :0}
	save_data()
	reset_timer_data()
...
func load_data():
	if FileAccess.file_exists(save_path):
		...
		if typeof(data) == TYPE_DICTIONARY:
			general_data = data.get("general_data",{"stomps" : 0, "consumed_stomps": 0,"fruits" : 0,"stomps_per_fruit" : 10,"total_dinos" : 1, "amount_per_click":1,"dino_souls" : 0, "dino_unlocked" : {"stego" : true, "ptero" : false},})
			dino_stats = data.get("dino_stats",{"stego" : {"base_price" : 2, "current_price" : 2, "number" : 1, "stomp_per_jump":1}, "ptero" : {"base_price" : 1, "current_price" : 1, "number" : 0, "stomp_per_jump": 0}})
...
func _on_reset_data() -> void:
	...
	time_dico = {"crash_timer" : 60,"threshold" : 10}
	general_data["amount_per_click"] = 1
	general_data["dino_unlocked"]["ptero"] = false
	save_data()
	reset_timer_data()
